...
import type { ExternalBlob as _ExternalBlob, Note as _Note, NoteId as _NoteId, SaveNoteRequest as _SaveNoteRequest, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async askQuestion(arg0: NoteId, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async listNotes(): Promise<Array<NoteMetadata>> {
        if (this.processError) {
            try {
    ...
    async saveNote(arg0: SaveNoteRequest): Promise<NoteId> {
        if (this.processError) {
            try {
                const result = await this.actor.saveNote(await to_candid_SaveNoteRequest_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async summarizeNote(arg0: NoteId): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.summarizeNote(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Note]): Promise<Note | null> {
    return value.length === 0 ? null : await from_candid_Note_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        summary: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.summary)),
...
async function to_candid_SaveNoteRequest_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SaveNoteRequest): Promise<_SaveNoteRequest> {
...
async function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        externalBlob: await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.externalBlob),
        mimeType: value.mimeType,
        filename: value.filename,
        textContent: value.textContent
    };
